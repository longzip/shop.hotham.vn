                ...
                <div className="relative">
                    ...
                    <div id="md-searchbar" className={`${mdOptionsToggle ? "hidden" : "flex"} bg-white lg:hidden py-5 px-6 items-center justify-between`}>
                        <div className="flex items-center space-x-3 text-gray-800">
                            ...
                            <input type="text" placeholder="Tìm kiếm sản phẩm" className="text-sm leading-none  text-gray-600 focus:outline-none" />
                        </div>
                    ...
                    <div className=" bg-gray-50 px-6 py-9">
                        <div className="container mx-auto flex items-center justify-between">
                            <div className="md:w-2/12 cursor-pointer text-gray-800 " aria-label="the Crib.">
                                
                                <Link href="/">
								<a>
									{
										logo ? (
											<img className="mr-2 h-16 w-auto" src={ logo.sourceUrl } alt={ `${ siteName } logo` }/>
										) : {siteName}
									}
								</a>
							</Link>
                            ...
                            <div className="md:w-2/12 justify-end flex items-center space-x-4 xl:space-x-8">
                                <div className="hidden lg:flex items-center">
                                    ...
                                    <input id="searchInput" type="text" placeholder="tìm kiếm" className={` ${searchInput ? "hidden" : ""} text-sm  text-gray-600 rounded ml-1 border border-transparent focus:outline-none focus:border-gray-400 px-1`} />
                                </div>
                                <div className="hidden lg:flex items-center space-x-4 xl:space-x-8">
                                    ...
                                    <Link href="/gio-hang/">
                                    <a aria-label="go to cart" className="text-gray-800   focus:outline-none focus:ring-2 focus:ring-gray-800">
                    ...
                    <div id="mobile-menu" className={`${showMenu ? "flex" : "hidden"} absolute z-10 inset-0 md:hidden bg-white flex-col h-screen w-full`}>
                        <div className="flex items-center justify-between border-b border-gray-200 pb-4 p-4">
                            <div className="flex items-center space-x-3">
                                ...
                                <input type="text" placeholder="Tìm kiếm sản phẩm" className="text-sm text-gray-600 placeholder-gray-600  focus:outline-none" />
                            </div>

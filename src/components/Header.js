      ...
      <header className="relative bg-white">
        <div id="alert-1" class="flex items-center p-4 mb-4 text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400" role="alert">
          ...
          <div class="ms-3 text-sm font-medium">
            <span class="font-medium">[Miễn phí!] </span> Biểu minh họa mức đóng, mức hưởng bảo hiểm xã hội tự nguyện 2024. <a target="_blank" href="https://bhxh.hotham.vn/muc-dong" class="font-semibold underline hover:no-underline">Truy cập ngay</a>.
          </div>
          {/* <div
